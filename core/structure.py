...
def generate_structure(image_path, dem_path):
    # DEM_PATH = os.path.join(dem_path, "dem.tif")
    REF_PATH = os.path.join(image_path, "B04.tiff")
    ...
    for b in band_list:
        path = os.path.join(image_path, b)
    ...
    out_file = os.path.join(OUT_DIR, "structure_features.npy")
